...
`/home/gionag/Development/spola-backend/`

## Files to Create/Modify

### 1. SkillDefinition.kt — FULL REWRITE
**Path**: `spola-backend-core/src/main/kotlin/dev/spola/skill/SkillDefinition.kt`
...
**Path**: `spola-backend-core/src/main/kotlin/dev/spola/skill/SkillParser.kt`
 ...
 * Built at startup by scanning ~/.spola/skills/ for SKILL.md files.
 */
class SkillCatalog(
...
**Path**: `spola-backend-core/src/main/kotlin/dev/spola/skill/SkillLoader.kt`
...
object SkillLoader {
    val defaultSkillsDir: Path = Path.of(home, ".spola", "skills")
...
**Path**: `spola-backend-cli/src/main/kotlin/dev/spola/cli/SkillCommand.kt`
...
- Do NOT modify SpolaAgent.kt ReAct loop

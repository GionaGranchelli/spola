...
**Path**: `spola-backend-core/src/main/kotlin/dev/spola/skill/SkillRepository.kt`

SQLite-backed repository using Exposed (same pattern as SqliteMemoryStore).
Follow the existing patterns in `spola-backend-core/src/main/kotlin/dev/spola/memory/SqliteMemoryStore.kt`.
...
**Path**: `spola-backend-core/src/main/kotlin/dev/spola/skill/SkillIndexer.kt`
...
**Path**: `spola-backend-core/src/main/kotlin/dev/spola/skill/SkillCatalog.kt`
...
**Path**: `spola-backend-core/src/main/kotlin/dev/spola/skill/SkillTools.kt`
...
**Path**: `spola-backend-core/src/main/kotlin/dev/spola/factory/AgentFactory.kt`
...
### 6. SpolaConfig.kt — MODIFY
**Path**: `spola-backend-core/src/main/kotlin/dev/spola/SpolaConfig.kt`
...
**Path**: `spola-backend-core/src/main/kotlin/dev/spola/factory/ToolRegistryFactory.kt`
...
**Path**: `spola-backend-core/src/test/kotlin/dev/spola/skill/SkillRepositoryTest.kt`
...
**Path**: `spola-backend-core/src/test/kotlin/dev/spola/skill/SkillIndexerTest.kt`
...
- Do NOT modify SpolaAgent.kt, Tool.kt, ChatMessage.kt, Runner.kt, SpolaFactory.kt, SpolaInstance.kt
...
cd /home/gionag/Development/spola

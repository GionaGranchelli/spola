...
3. **No SpolaAgent.kt changes**: `callLlm()` calls `toolRegistry.schemas()` every
   turn — new tools appear automatically on the next LLM request.

## Files to Modify

### 1. ToolRegistry.kt — MODIFY
**Path**: `spola-backend-core/src/main/kotlin/dev/spola/Tool.kt`
...
**Path**: `spola-backend-core/src/test/kotlin/dev/spola/skill/ToolRegistryDynamicTest.kt`
...
- Do NOT modify SpolaAgent.kt, SpolaInstance.kt, Runner.kt, SpolaFactory.kt

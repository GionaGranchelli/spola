...
- SpolaClient API layer is clean
...
```
composeApp/src/commonMain/kotlin/dev/spola/app/
├── app/
│   ├── App.kt                          # Root: BottomTabBar + Page host
│   ├── theme/
│   │   ├── Theme.kt                    # SpolaTheme (dark/light)
...
### Backend Changes (spola-backend-core)

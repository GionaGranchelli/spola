...
/**
 * Configuration for the Golem agent.
 */
data class GolemConfig(
    ...
    val memoryDbPath: String = "./.golem/memory.db",
    val workflowDbPath: String = "./.golem/workflows.db",
    val schedulerDbPath: String = "./.golem/scheduler.db",
    val kanbanDbPath: String = "./.golem/kanban.db",
    val kanbanWorkflowCooldownSeconds: Long = 30,
    val compressionEnabled: Boolean = true,
    val checkpointDbPath: String = "./.golem/checkpoint.db",
    val jvmIndexDbPath: String = "./.golem/jvm-index.db",
    ...
    val otelServiceName: String = "golem",
    val metricsEnabled: Boolean = true,
    val pluginsEnabled: Boolean = true,
    val pluginsDir: String = Path.of(System.getProperty("user.home"), ".golem", "plugins").toString(),
    ...
    val imageGenOutputDir: String = Path.of(
        System.getProperty("user.home"), ".golem", "images"
    ).toString(),
    // Custom agent configuration
    val agentsDir: String = Path.of(System.getProperty("user.home"), ".golem", "agents").toString(),
    val agentsDbPath: String = "./.golem/agents.db",
    val defaultAgentId: String? = null,
    val sessionsDbPath: String = "./.golem/sessions.db",
    ...
    // YAML workflow definitions directory (default: ~/.golem/workflows/)
    val workflowsDir: String = Path.of(
        System.getProperty("user.home"), ".golem", "workflows"
    ).toString(),

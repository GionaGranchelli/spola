...
internal val allowedDirs: List<Path> by lazy {
    val envAllowed = System.getenv("GOLEM_ALLOWED_DIRS")
...
internal fun resolvePath(path: String, config: GolemConfig? = null): Path {
...
fun registerFileTools(registry: ToolRegistry, config: GolemConfig? = null) {

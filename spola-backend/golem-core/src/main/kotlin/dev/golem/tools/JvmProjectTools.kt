...
fun registerJvmTools(
    ...
    registry.register(Tool(
        ...
        parameters = listOf(
            ...
            ToolParameter("module", "Optional Gradle module name, e.g. :golem-core", ToolParameterType.STRING, required = false),
        ),
        execute = { args ->
            try {
    ...
    registry.register(Tool(
        ...
        execute = { args ->
            try {
                ...
                val graph = ModuleDependencyGraph(SqliteDependencyCache("./.golem/dependency-cache.db"))

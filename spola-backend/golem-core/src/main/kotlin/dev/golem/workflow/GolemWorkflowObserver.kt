...
/**
 * Bridges TramAI's WorkflowObserver to Golem's existing observability:
 * - AgentRunObserver (real-time SSE events)
 * - Prometheus metrics (GolemMetrics)
 * - OpenTelemetry tracing (GolemTracer)
 */
class GolemWorkflowObserver(
    private val agentObserver: AgentRunObserver? = null,
    private val metrics: GolemMetrics? = null,
    private val tracer: GolemTracer? = null,

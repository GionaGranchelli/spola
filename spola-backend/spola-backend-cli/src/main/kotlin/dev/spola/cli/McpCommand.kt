 ...
 *
 * Usage: `spola mcp add/list/remove/reconnect`
 */
@Command(
    name = "mcp",
...
/**
 * `spola mcp add <name> --cmd <command> [--args ...] [--url <sse-url>]`
 */
@Command(
    name = "add",
...
private fun configPath(root: SpolaCli): String {
    return java.nio.file.Path.of(root.workdir, ".spola", "mcp-servers.json").toString()
}
